...
-- use :! for vim, use :term for neovim
vim.keymap.set("n", "<f5>", ":w <CR> :term clear ; g++ --std=c++11 -O2 -Wall %; if [ -f a.out ]; then time ./a.out; rm a.out; fi <CR>")
vim.keymap.set("n", "<f6>", ":vs %:r.in <CR>")
-- vim.keymap.set("n", "<f5>", ":w <bar> :!g++ --std=c++11 -O2 -Wall %:r.cc -o %:r<CR>")
